...
<main id="primary" class="site-main">
    ...
    <!-- Курсы -->
    <section class="courses-section section" itemscope itemtype="https://schema.org/ItemList">
        <div class="container">
                        ...
                        <div class="slider-track">
                             ...
                             <div class="course-card">
                                 <div class="course-image">
                                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/kurs01.jpg" alt="Денежный тренинг: Я и деньги. Что было! Что есть! Что будет!" loading="lazy">
                                 </div>
                             ...
                             <div class="course-card">
                                 <div class="course-image">
                                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/kurs02.jpg" alt="Психология бизнеса: Управление и лидерство" loading="lazy">
                                 </div>
                                <div class="course-content">
                             ...
                             <div class="course-card">
                                 <div class="course-image">
                                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/kurs03.jpg" alt="Интегральная психология: Теория и практика" loading="lazy">
                                 </div>
                                <div class="course-content">
