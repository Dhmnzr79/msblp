            ...
            <div class="partners-grid">
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert01.jpg" alt="Глобал Консалтинг" />
                    </div>
                    <h3 class="partner-name">Глобал Консалтинг</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert02.jpg" alt="Инновационные решения" />
                    </div>
                    <h3 class="partner-name">Инновационные решения</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert03.jpg" alt="Бизнес Академия" />
                    </div>
                    <h3 class="partner-name">Бизнес Академия</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert04.jpg" alt="Лидерство Плюс" />
                    </div>
                    <h3 class="partner-name">Лидерство Плюс</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert05.jpg" alt="Психология Успеха" />
                    </div>
                    <h3 class="partner-name">Психология Успеха</h3>
                </div>
            </div>
        </div>
    </section>
