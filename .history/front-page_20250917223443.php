        ...
        <div class="container">
            ...
            <div class="what-we-do-grid">
                ...
                <div class="card-item card-3">
                    ...
                    <p>3.	Работаем с тем, что внутри: зачем ты живешь, куда идешь, какие ценности движут тобой. Это дает энергию, фокус и ясность в решениях и действиях</p>
                </div>
                
                <div class="card-item card-4">
                    <div class="card-number">04.</div>
                    <p>4.	Настоящие лидеры – не те, у кого должность, а те, кто, меняясь сами, вдохновляют на изменения других. Мы учим быть такими – через глубинную работу над собой и развитие духовного интеллекта</p>
                </div>
