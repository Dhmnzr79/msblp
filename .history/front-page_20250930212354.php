                ...
                <div class="hero-content" style="grid-column: 1 / 7;">
                    ...
                    <div class="school-advantages">
                        ...
                        <div class="advantage-item">
                            ...
                            <p>Н3.	Наши выпускники владеют набором эксклюзивных инструментов, направленных на максимальное раскрытие творческого потенциала личности, развитие интуитивных способностей, помогающих развивать свой бизнес и успешно решать острые социально-экономические проблемы общества, содействуя его прогрессу.</p>
                        </div>
                    </div>
    ...
    <section class="what-we-do-section section">
        <div class="container">
            <div class="section-title">
                ...
                <p>На формируем интеллектуальную элиту общества – лидеров, которые не только знают реальность такой, какова она есть, но способны ею управлять</p>
            </div>
    ...
    <section class="partners-section section">
        <div class="container">
            ...
            <div class="partners-grid">
                ...
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert01.jpg" alt="Международная ассоциация онтопсихологии" />
                    </div>
