# Каталог сеток - ЕДИНСТВЕННЫЙ ИСТОЧНИК ИСТИНЫ
...
```bash
grep "\.new-class" style.css
```

### ✅ Документирование:
Все новые сетки добавлять ТОЛЬКО в этот файл.
...
### Сетка #12: Базовые классы колонок
```
┌────┬────┬────┬────┬────┬────┬────┬────┬────┬────┬────┬────┐
...
**Доступные классы:**
- `.grid-col-1` до `.grid-col-12` - занимает от 1 до 12 колонок
- На мобилках (< 768px) все колонки становятся полной ширины (12/12)

**HTML пример:**
```html
<div class="grid grid-12">
    <div class="grid-col-8">
        <!-- Контент на 8 колонок -->
    </div>
    <div class="grid-col-4">
        <!-- Контент на 4 колонки -->
    </div>
</div>
```
