        ...
        <div class="container">
            <div class="page-content">
                ...
                <div class="content-block">
                    <div class="grid grid-2">
                        <div class="about-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/kurs02.jpg" alt="Результаты курса" />
                        </div>

                        <div class="about-content">
                            <h3>Практические инструменты</h3>
                            <p>Научитесь использовать техники онтопсихологии для решения реальных жизненных и бизнес-задач. Получите конкретные методики работы с бессознательным, развития интуиции и креативности.</p>
                            
                            <h3>Глубинное понимание себя</h3>
                            <p>Узнаете свои истинные мотивы, страхи и ограничения. Научитесь различать собственные потребности от навязанных обществом стереотипов и установок.</p>
                        </div>
                    </div>
                </div>
            </div>
