...
<main id="primary" class="site-main">
            ...
            <div class="hero-content">
                    ...
                    <div class="school-advantages">
                        <div class="advantage-item">
                            ...
                            <p>Наши слушатели формируют креативное мышление лидера, помогающее им на практике управлять реальностью для успешной самореализации, развития своего дела и своей команды, совершенствования своего социального контекста.</p>
                        </div>
                        ...
                        <div class="advantage-item">
                            ...
                            <p>Современные лидеры призваны стать интеллектуальной элитой бизнеса и общества, чтобы эффективно отвечать на глобальные вызовы ХХI века, решая возникающие проблемы и предлагая креативные решения, которые служат развитию и процветанию человечества.</p>
                        </div>
                        ...
                        <div class="advantage-item">
                            ...
                            <p>Наши выпускники владеют набором эксклюзивных инструментов, направленных на максимальное раскрытие творческого потенциала личности, развитие интуитивных способностей, помогающих развивать свой бизнес и успешно решать острые социально-экономические проблемы общества, содействуя его прогрессу.</p>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="what-we-do-grid">
                <div class="card-item card-1">
                    ...
                    <p>Распространяем идеи осознанного лидерства, онтологического мышления и глубинных ценностей среди тех, кто влияет на своё окружение: предпринимателей, экспертов, управленцев, преподавателей, общественных деятелей.</p>
                </div>
                
                <div class="card-item card-2">
                    <div class="card-number">02.</div>
                    <p>Даём современные подходы, проверенные инструменты и живую практику, чтобы люди и организации были жизнеспособными, эффективными, успешными.</p>
                </div>
                
                <div class="card-item card-3">
                    <div class="card-number">03.</div>
                    <p>Работаем с тем, что внутри: зачем ты живешь, куда идешь, какие ценности движут тобой. Это дает энергию, фокус и ясность в решениях и действиях</p>
                </div>
                
                <div class="card-item card-4">
                    <div class="card-number">04.</div>
                    <p>Настоящие лидеры – не те, у кого должность, а те, кто, меняясь сами, вдохновляют на изменения других. Мы учим быть такими – через глубинную работу над собой и развитие духовного интеллекта</p>
                </div>
        ...
        <div class="container">
            <div class="features-grid">
                <div class="feature-item">
                    ...
                    <p class="feature-text">Наши преподаватели являются действующими предпринимателями, профессионалами в своей сфере деятельности, а также экспертами в бизнес-психологии, онтопсихологии и лидерства</p>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <p class="feature-text">Все программы – это методически выверенные образовательные продукты. Краткосрочные курсы длятся от 3 до 7 дней. Этого достаточно, чтобы получить первые результаты. А для устойчивых изменений и долгосрочных результатов созданы флагманские программы, продолжительностью от 3 месяцев до 2 лет.</p>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <p class="feature-text">Наши выпускники достигают значительных результатов в своей карьере и росте бизнеса. Используя полученные знания и навыки, они успешно развивают и совершенствуют широкий социальный контекст от семьи и бизнеса, до сообществ и государств.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Преподаватели -->
    <section class="teachers-section section" style="display: none;">
        <div class="container">
            <div class="section-title">
            ...
            <div class="slider-wrap" id="teachers-slider">
                ...
                if ($teachers->have_posts()) :
                    ...
                    wp_reset_postdata();
                                ...
                                <article class="teacher-card">
                                    <div class="teacher-media">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/teacher-placeholder.jpg" alt="Островский Александр Валентинович">
                                        <svg class="teacher-icon" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_590_3007)">
                                                <rect x="9" y="11" width="29" height="29" fill="white"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M24 48C27.1517 48 30.2726 47.3792 33.1844 46.1731C36.0962 44.967 38.742 43.1992 40.9706 40.9706C43.1992 38.742 44.967 36.0962 46.1731 33.1844C47.3792 30.2726 48 27.1517 48 24C48 20.8483 47.3792 17.7274 46.1731 14.8156C44.967 11.9038 43.1992 9.25804 40.9706 7.02944C38.742 4.80083 36.0962 3.033 33.1844 1.82689C30.2726 0.620778 27.1517 -4.69644e-08 24 0C17.6348 9.48488e-08 11.5303 2.52856 7.02944 7.02944C2.52856 11.5303 0 17.6348 0 24C0 30.3652 2.52856 36.4697 7.02944 40.9706C11.5303 45.4714 17.6348 48 24 48ZM23.3813 33.7067L36.7147 17.7067L32.6187 14.2933L21.152 28.0507L15.2187 22.1147L11.448 25.8853L19.448 33.8853L21.512 35.9493L23.3813 33.7067Z" fill="#0084FE"/>
                                    ...
                                    <div class="teacher-body">
                                        <h3 class="teacher-name">Островский Александр Валентинович</h3>
    ...
    <!-- Статистика -->
    <section class="statistics-section section" style="display: none;">
        <div class="container">
                ...
                if ($testimonials->have_posts()) :
                    ...
                    wp_reset_postdata();
                                ...
                                <article class="testimonial-card">
                                    ...
                                    <div class="testimonial-body">
                                        <p>Изучение интегральной онтопсихологии позволило найти точные ответы на важные для меня вопросы о том, как устроен человек и как ему делать верные выборы и быть эффективным строителем собственной судьбы. До этого я читала много книг по философии и религии, проходила тренинги, участвовала в ретритах. Но только на программе переподготовки по интегральной онтопсихологии нашла то, что давно искала – понятную теорию и работающие технологии развития себя и своего окружения без воды и пустых обещаний. Это сильно помогает мне не только в личной жизни, но и в бизнесе.</p>
                                        <div class="testimonial-author">
                                ...
                                <article class="testimonial-card">
                                    ...
                                    <div class="testimonial-body">
                                        <p>Для меня, как предпринимателя, очень важно, чтобы мои сотрудники были продуктивными, а для этого я должен понимать причины их поведения. Мой партнер по бизнесу, которому я доверяю, обратил внимание на программу по применению интегральной онтопсихологии в практике бизнеса. Я прошел обучение и многое узнал о глубинной мотивации, которая влияет на решения и поступки человека. А главное, я получил практические инструменты для работы с бессознательным человека и управления групповой динамикой.</p>
                                        <div class="testimonial-author">
                                ...
                                <article class="testimonial-card">
                                    ...
                                    <div class="testimonial-body">
                                        <p>Интегральная онтопсихология в применении к бизнесу – это не просто очередная заумная теория или философия. Это конкретное знание реальности, подкрепленное практическими технологиями, которые можно легко применять в реальной деловой и профессиональной жизни. Я очень довольна, что открыла для себя интегральную онтопсихологию и прошла несколько курсов в ВШБПЛ. Более того, несколько моих ключевых сотрудников тоже прошли обучение на тренингах в Школе. </p>
                                        <div class="testimonial-author">
                                ...
                                <article class="testimonial-card">
                                    ...
                                    <div class="testimonial-body">
                                        <p>Мгновенно понимать суть ситуации и находить решение проблемы – это важное качество лидера. На тренинге я научился развивать свои интуитивные способности, отличать настоящую интуицию от иллюзий и фантазий. Я освоил простые, но очень эффективные техники по прокачке интуиции и сам был удивлен теми результатами, которые получил. Теперь я не только доверяю своему чутью, но смело применяю интуицию не только в бизнесе, но и в повседневной жизни. А еще я рекомендовал тренинг по интуиции всем своим близким друзьям и партнерам по бизнесу.</p>
                                        <div class="testimonial-author">
            ...
            <div class="partners-grid">
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert01.jpg" alt="Федеральный институт развития образования РАНХиГС при Президенте РФ" />
                    </div>
                    <h3 class="partner-name">Федеральный институт развития образования РАНХиГС при Президенте РФ (Россия)</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert02.jpg" alt="Школа Управления Сколково" />
                    </div>
                    <h3 class="partner-name">Школа Управления Сколково</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert03.jpg" alt="Менегетти (Бразилия)" />
                    </div>
                    <h3 class="partner-name">Факультет управления и администрирования им. Антонио Менегетти (Реканто Маэстро, Бразилия)</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert04.jpg" alt="Центр креативного лидерства" />
                    </div>
                    <h3 class="partner-name">Центр креативного лидерства (Center for Creative Leadership, США)</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert05.jpg" alt="Университет La Sapienza" />
                    </div>
                    <h3 class="partner-name">Университет «La Sapienza» (Рим, Италия)</h3>
                </div>
                
                <div class="partner-card">
                    <div class="partner-logo">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pert06.jpg" alt="Международная ассоциация онтопсихологии" />
                    </div>
                    <h3 class="partner-name">Фонд научных и гуманистических исследований Антонио Менегетти (Швейцария)</h3>
                </div>
            </div>
        </div>
    </section>
