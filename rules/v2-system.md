...
### ❌ ЗАПРЕЩЕНО:
1. **НЕ ДОБАВЛЯТЬ СТИЛИ** самостоятельно - только по промпту!
2. **НЕ ПРАВИТЬ КОНТЕНТ** самостоятельно - только по промпту!
3. **НЕ ИЗМЕНЯТЬ СТРУКТУРУ** HTML без разрешения!
4. **НЕ ДЕЛАТЬ ЗАГОЛОВКИ** из текста без промпта!
